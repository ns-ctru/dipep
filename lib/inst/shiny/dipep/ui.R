    ...
    fluidPage(
        ...
        sidebarPanel(width = 3,
                     ...
                     checkboxGroupInput('current', 'Current Pregnancy...',
                                        choices = c('Problems with This Pregnancy'      = 'this.pregnancy.problems',
                                                    'Multiple Pregnancy'                = 'multiple.preg',
                                                    'Cesarean'                          = 'cesarean',
                                                    'Injury'                            = 'injury',
                                                    'Trimester'                         = 'trimester',
                                        ...
                                        selected = c('this.pregnancy.problems', 'multiple.preg',
                                                     'cesarean', 'injury', 'trimester',
