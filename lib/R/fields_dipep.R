...
fields_dipep <- function(df      = master$follow.up.30.day,
    ...
    names.df$description[names.df$variable == 'wells.permissive.score'] <- 'Wells (Permissive) - Score'
    ...
    names.df$description[names.df$variable == 'wells.strict.score'] <- 'Wells (Strict) - Score'
    ...
    names.df$description[names.df$variable == 'simplified.score'] <- 'Simplified Revised Geneva - Score'
    ...
    names.df$description[names.df$variable == 'perc.score'] <- 'PERC - Score'
