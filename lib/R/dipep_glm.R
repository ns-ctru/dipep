...
dipep_glm <- function(df              = .data,
    ...
    results$tidied <- results$tidied %>%
        mutate(term = case_when(.$term == '(Intercept)' ~  '(Intercept)',
                                .$term == 'simplified.peSimplified PE' ~  'Geneva',
                                .$term == 'simplified.peNo Simplified PE' ~  'Geneva',
                                .$term == 'simplified.pe' ~  'Geneva',
                                ...
                                .$term == 'aptt' ~ 'APTT',
                                .$term == 'prothombin.time.catNormal' ~ 'Prothombin (Time)',
                                .$term == 'prothombin.time.catAbnormal' ~ 'Prothombin (Time)',
                                .$term == 'prothombin.time' ~ 'Prothombin (Time)',
                                .$term == 'clauss.fibrinogen.catNormal' ~ 'Clauss Fibrinogen',
                                .$term == 'clauss.fibrinogen.catAbnormal' ~ 'Clauss Fibrinogen',
                                .$term == 'clauss.fibrinogen' ~ 'Clauss Fibrinogen',
                                .$term == 'ddimer.innovance.catNormal' ~ 'D-Dimer (Innovance)',
                                .$term == 'ddimer.innovance.catAbnormal' ~ 'D-Dimer (Innovance)',
                                .$term == 'ddimer.innovance' ~ 'D-Dimer (Innovance)',
                                .$term == 'ddimer.elisa.catNormal' ~ 'D-Dimer (ELISA)',
                                .$term == 'ddimer.elisa.catAbnormal' ~ 'D-Dimer (ELISA)',
