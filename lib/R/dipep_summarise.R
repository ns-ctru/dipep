    ...
    if(group.as.col == TRUE){
        results <- results %>%
                   ...
                   mutate(Statistic = row.names(.),
                          ...
                          Measurement = gsub('appt', 'APTT', Measurement),
                          Measurement = gsub('appt.cat', 'APTT : Dichotomised', Measurement),
                          Measurement = gsub('prothombin.time', 'Prothombin (Time)', Measurement),
                          Measurement = gsub('prothombin.time.cat', 'Prothombin (Time) : Dichotomised', Measurement),
                          ...
                          Measurement = gsub('ddimer.innovanance', 'D-Dimer (Innovance)', Measurement),
                          Measurement = gsub('ddimer.innovanance.cat', 'D-Dimer (Innovance) : Dichotomised', Measurement),
