...
clean_case_review <- function(df  = master$case.review1,
    ...
    names(df) <- gsub('primary.class', 'primary', names(df))
    names(df) <- gsub('secondary.class', 'secondary', names(df))
    names(df) <- gsub('class', paste0('class', reviewer), names(df))
    names(df) <- gsub('primary', paste0('primary.class', reviewer, '.dm'), names(df))
    names(df) <- gsub('secondary', paste0('secondary.class', reviewer, '.dm'), names(df))
    return(df)
}
...
master$case.review <- left_join(case.review1,
    ...
    mutate(primary.class1   = case_when(.$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'Exclude',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE',
                                        .$img.class1 == 'I3'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I3'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'No PE',
                                        .$img.class1 == 'I3'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I3'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE',
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'Exclude',
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'Exclude'),
           primary.class2   = case_when(.$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'Exclude',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE',
                                        .$img.class2 == 'I3'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I3'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'No PE',
                                        .$img.class2 == 'I3'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I3'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE',
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'Exclude',
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'Exclude'),
           primary.class3   = case_when(.$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'Exclude',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE',
                                        .$img.class3 == 'I3'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I3'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'No PE',
                                        .$img.class3 == 'I3'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I3'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE',
                                        .$img.class3 == 'I4'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I4'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'Exclude',
                                        .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'Exclude'),
           secondary.class1   = case_when(.$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                          .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                          .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                          ...
                                          .$img.class1 == 'I1b' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                          .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                          .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE',
                                          .$img.class1 == 'I3'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I3'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'No PE',
                                          ...
                                          .$img.class1 == 'I3'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE',
                                          .$img.class1 == 'I4'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I4'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                          .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                          .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'Exclude'),
           secondary.class2   = case_when(.$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                          .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                          .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                          ...
                                          .$img.class2 == 'I1b' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                          .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                          .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE',
                                          .$img.class2 == 'I3'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I3'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'No PE',
                                          ...
                                          .$img.class2 == 'I3'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE',
                                          .$img.class2 == 'I4'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I4'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                          .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                          .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'Exclude'),
           secondary.class3   = case_when(.$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                          .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                          .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                          ...
                                          .$img.class3 == 'I1b' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                          .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                          .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE',
                                          .$img.class3 == 'I3'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I3'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'No PE',
                                          ...
                                          .$img.class3 == 'I3'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE',
                                          .$img.class3 == 'I4'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I4'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                          .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                          .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'Exclude'),
           tertiary.class1   = case_when(.$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                         .$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                         .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                         .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                         .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                         ...
                                         .$img.class1 == 'I4'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'Exclude',
                                         .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                         .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE'),
           tertiary.class2   = case_when(.$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                         .$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                         .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                         .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                         .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                         ...
                                         .$img.class2 == 'I4'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'Exclude',
                                         .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                         .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE'),
           tertiary.class3   = case_when(.$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                         .$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                         .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                         .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                         .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                         ...
                                         .$img.class3 == 'I4'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'Exclude',
                                         .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                         .$img.class3 == 'I4'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE'),
           quaternary.class1   = case_when(.$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I1a' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'PE',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'Exclude',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'Exclude',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'Exclude',
                                        .$img.class1 == 'I1b' & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'Exclude',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T1' & .$fup.class1 == 'F2' ~ 'Exclude',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I2'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'No PE',
                                        ...
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F1' ~ 'PE',
                                        .$img.class1 == 'I4'  & .$trt.class1 == 'T2' & .$fup.class1 == 'F2' ~ 'Exclude'),
           quaternary.class2   = case_when(.$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I1a' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'PE',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'Exclude',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'Exclude',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'Exclude',
                                        .$img.class2 == 'I1b' & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'Exclude',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T1' & .$fup.class2 == 'F2' ~ 'Exclude',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I2'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'No PE',
                                        ...
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F1' ~ 'PE',
                                        .$img.class2 == 'I4'  & .$trt.class2 == 'T2' & .$fup.class2 == 'F2' ~ 'Exclude'),
           quaternary.class3   = case_when(.$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I1a' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'PE',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'Exclude',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'Exclude',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'Exclude',
                                        .$img.class3 == 'I1b' & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'Exclude',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T1' & .$fup.class3 == 'F2' ~ 'Exclude',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F1' ~ 'PE',
                                        .$img.class3 == 'I2'  & .$trt.class3 == 'T2' & .$fup.class3 == 'F2' ~ 'No PE',
           ...
           secondary.class     = ifelse(secondary.class == 'Exclude',
                                      yes = NA,
                                      no  = secondary.class),
           tertiary.class     = ifelse(tertiary.class1 == tertiary.class2,
                                       yes = tertiary.class1,
                                       no  = tertiary.class3),
           tertiary.class     = ifelse(tertiary.class == 'Exclude',
                                       yes = NA,
                                       no  = tertiary.class),
           quaternary.class     = ifelse(quaternary.class1 == quaternary.class2,
                                         yes = quaternary.class1,
                                         no  = quaternary.class3),
           quaternary.class     = ifelse(quaternary.class == 'Exclude',
                                         yes = NA,
                                         no  = quaternary.class),
           primary.class.dm     = ifelse(primary.class1.dm == primary.class2.dm,
                                         yes = primary.class1.dm,
                                         no  = primary.class3.dm),
           primary.class.dm     = ifelse(primary.class.dm == 'Exclude',
                                         yes = NA,
                                         no  = primary.class.dm),
           secondary.class.dm   = ifelse(secondary.class1.dm == secondary.class2.dm,
                                         yes = secondary.class1.dm,
                                         no  = secondary.class3.dm),
           secondary.class.dm   = ifelse(secondary.class.dm == 'Exclude',
                                         yes = NA,
                                         no  = secondary.class.dm))
