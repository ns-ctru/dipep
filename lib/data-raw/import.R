...
master$biomarker_tidy <- master$biomarker_tidy %>%
    mutate(prothombin.time.cat = ifelse(prothombin.time < 11.7 | prothombin.time > 15.9,
           ...
           prothombin.time.cat = relevel(prothombin.time.cat,
                                         ref = 'Normal'),
           prothrombin.fragments.cat = ifelse(prothrombin.fragments < 200 | prothrombin.fragments > 1200,
                                              yes = 'Abnormal',
                                              no  = 'Normal'),
           ...
           prothrombin.fragments.cat = relevel(prothrombin.fragments.cat,
                                               ref = 'Normal'),
           aptt.cat = ifelse(aptt < 27 | aptt > 52,
                             yes = 'Abnormal',
                             no  = 'Normal'),
           ...
           clauss.fibrinogen.cat = relevel(clauss.fibrinogen.cat,
                                              ref = 'Normal'),
           thrombin.generation.endogenous.potential.cat = ifelse(thrombin.generation.endogenous.potential < 696 | thrombin.generation.endogenous.potential > 1533,
                                                                 yes = 'Abnormal',
                                                                 no  = 'Normal'),
           ...
           thrombin.generation.endogenous.potential.cat = relevel(thrombin.generation.endogenous.potential.cat,
                                                                  ref = 'Normal'),
           thrombin.generation.lag.time.cat = ifelse(thrombin.generation.lag.time < 0.9 | thrombin.generation.lag.time > 3.4,
                                                     yes = 'Abnormal',
                                                     no  = 'Normal'),
           ...
           thrombin.generation.lag.time.cat = relevel(thrombin.generation.lag.time.cat,
                                                      ref = 'Normal'),
           thrombin.generation.time.to.peak.cat = ifelse(thrombin.generation.time.to.peak < 1.4 | thrombin.generation.time.to.peak > 7.7,
                                                         yes = 'Abnormal',
                                                         no  = 'Normal'),
           ...
           thrombin.generation.time.to.peak.cat = relevel(thrombin.generation.time.to.peak.cat,
                                                          ref = 'Normal'),
           thrombin.generation.peak.cat = ifelse(thrombin.generation.peak < 103 | thrombin.generation.peak > 475,
                                                 yes = 'Abnormal',
                                                 no  = 'Normal'),
           ...
           thrombin.generation.peak.cat = relevel(thrombin.generation.peak.cat,
                                                  ref = 'Normal'),
           ddimer.innovance.cat = ifelse(ddimer.innovance < 0 | ddimer.innovance > 1.13,
                                         yes = 'Abnormal',
                                         no  = 'Normal'),
           ...
           ddimer.elisa.cat = relevel(ddimer.elisa.cat,
                                      ref = 'Normal'),
           plasmin.antiplasmin.cat = ifelse(plasmin.antiplasmin < 150 | plasmin.antiplasmin > 800,
                                            yes = 'Abnormal',
                                            no  = 'Normal'),
           ...
           plasmin.antiplasmin.cat = relevel(plasmin.antiplasmin.cat,
                                             ref = 'Normal'),
           tissue.factor.cat = ifelse(tissue.factor < 40 | tissue.factor > 300,
                                      yes = 'Abnormal',
                                      no  = 'Normal'),
           ...
           tissue.factor.cat = relevel(tissue.factor.cat,
                                       ref = 'Normal'),
           troponin.cat = ifelse(troponin < 0.91 | troponin > 2.63,
                                 yes = 'Abnormal',
                                 no  = 'Normal'),
           ...
           troponin.cat = relevel(troponin.cat,
                                  ref = 'Normal'),
           bnp.cat = ifelse(bnp < 107 | bnp > 523,
                            yes = 'Abnormal',
                            no  = 'Normal'),
           ...
           bnp.cat = relevel(bnp.cat,
                             ref = 'Normal'),
           mrproanp.cat = ifelse(mrproanp < 0 | mrproanp > 954,
                                 yes = 'Abnormal',
                                 no  = 'Normal'),
