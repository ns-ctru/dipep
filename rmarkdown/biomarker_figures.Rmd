...
opts_chunk$set(cache.path = 'cache/',
               ...
               warning = FALSE,
               message = FALSE)
opts_chunk$set(fig.path = 'biomarker_figures/figures')
options(digits = 3)
...
```{r backup, echo = FALSE, results = 'hide', eval = TRUE}
...
```{r load, echo = FALSE, results = 'hide', eval = TRUE}
...
This document produces figures specifically for the Biomarker paper that is being written for peer review publication.

```{r child = 'biomarker_figures/results_biomarkers.Rmd', eval = TRUE}
```
