...
D-Dimers (ELISA)								| $< `d.dimer.high`$   | 0                   | `d.dimer.cat`
D-Dimers (ELISA)								| $\ge `d.dimer.high`$ | 1                   | `d.dimer.cat`
