Detailed description of the proposed analyses were formulated and signed-off in the Statistical Analysis Plan (SAP) as prescribed by the CTRUs *ST001 - The Statistical Analysis Plan* Standard Operatin Procedure (SOP), this document can be viewed [online](https://www.overleaf.com/read/rdyrzjmxxghz).  The methods described below are for the most part lifted directly from the SAP but has where necessary been modified to reflect what has actually been requested and performed.
...
Variable											| Boundry              | Classification/Risk
------------------------------------------------	|----------------------|--------------------------
Age													| $\le 35$             | 0
Age													| $>35$                | 1
BMI													| $< 30$               | 0
BMI													| $\ge 30$             | 1
Smoking												| Not Current Smoker   | 0
Smoking												| Current Smoker       | 1
Previous Pregnancy									| None                 | 0
Previous Pregnancy									| Any                  | 1
Previous Pregnancy Problems							| None                 | 0
Previous Pregnancy Problems							| Any                  | 1
History of thombosis in $1^o$ relatives				| None                 | 0
History of thombosis in $1^o$ relatives				| None                 | 1
History of Varicose Veins							| None                 | 0
History of Varicose Veins							| Any                  | 1
History of Intravenous drug use						| None                 | 0
History of Intravenous drug use						| Any                  | 1
History of thrombophilia							| None                 | 0
History of thrombophilia							| Any                  | 1
Surgery in last 4 weeks								| None                 | 0
Surgery in last 4 weeks								| Any                  | 1
Significant Injury in last 4 weeks                  | None                 | 0
Significant Injury in last 4 weeks                  | Any                  | 1
Past History of Thrombosis							| None                 | 0
Past History of Thrombosis							| Any                  | 1
Other Previous/Pre-existing Medical Problems        | None                 | 0
Other Previous/Pre-existing Medical Problems        | Any                  | 1
Pre or Post Partum									| Prepartum (i.e. pregnant)   | 0
Pre or Post Partum									| Postpartum                  | 1
Trimester											| $1^{st}$ or $2^{nd}$                 | 0
Trimester											| $3^{rd}$                             | 1
Multiple Pregnancy									| None                 | 0
Multiple Pregnancy									| Any (i.e. $\ge 2$)   | 1
Long haul Travel during Pregnancy                   | None                 | 0
Long haul Travel during Pregnancy                   | Any                  | 1
Period of Immobility/Bed Rest during pregnancy      | None                 | 0
Period of Immobility/Bed Rest during pregnancy      | Any                  | 1
Prior Thrombotic Event								| None                 | 0
Prior Thrombotic Event								| Any                  | 1
...
Pulmonary Embolism related ECG abnormality          | None                 | 0
Pulmonary Embolism related ECG abnormality          | Any                  | 1
Pulmonary Embolism related CXR abnormality          | None                 | 0
Pulmonary Embolism related CXR abnormality          | Any                  | 1
CXR shows alternative diagnosis                     | None                 | 0
CXR shows alternative diagnosis                     | Any                  | 1
...
Heart Rate										| $\le 100$ ($1^{st}$ or $2^{nd}$ trimester or postpartum) | 0
Heart Rate										| $\le 110$ ($3^{rd}$ trimester)                           | 0
Heart Rate										| $> 100$ ($1^{st}$ or $2^{nd}$ trimester or postpartum)   | 1
Heart Rate										| $> 110$ ($3^{rd}$ trimester)                             | 1
Respiratory Rate 								| $\le 24$                                                 | 0
Respiratory Rate (Tachypnea)                    | $> 24$                                                   | 1
Oxygen Saturation								| $\ge 94$                                                 | 0
Oxygen Saturation								| $< 94$                                                   | 1
Systolic Blood Pressure							| $\ge 90$                                                 | 0
Systolic Blood Pressure							| $< 90$                                                   | 1
Diastolic Blood Pressure						| $\ge 60$                                                 | 0
Diastolic Blood Pressure						| $< 60$                                                   | 1
Temperature										| $\le 37.4$                                               | 0
Temperature										| $> 37.4$                                                 | 1
D-Dimers (ELISA)								|  $< X$  | 0
D-Dimers (ELISA)								| $>= X $ | 1
D-Dimers (latex agglutination)					| $< X$   | 0
D-Dimers (latex agglutination)					| $>= X $ | 1
Plasmin-antiplasmin Assay (PAP)					| $< X$   | 0
Plasmin-antiplasmin Assay (PAP)					| $>= X $ | 1
Prothombin Fragmen 1+2 (PF 1+2)					| $< X$   | 0
Prothombin Fragmen 1+2 (PF 1+2)					| $>= X $ | 1
Thrombin Generation								| $< X$   | 0
Thrombin Generation								| $>= X $ | 1
Prothombin Time (PT)							| $< X$   | 0
Prothombin Time (PT)							| $>= X $ | 1
Activated Partial Thromboplastin Time (APTT)	| $< X$   | 0
Activated Partial Thromboplastin Time (APTT)    | $>= X $ | 1
Clauss Fibrinogen								| $< X$   | 0
Clauss Fibrinogen								| $>= X $ | 1
Soluble Tissue Factor (sTF)						| $< X$   | 0
Soluble Tissue Factor (sTF)						| $>= X $ | 1
Troponin I										| $< X$   | 0
Troponin I										| $>= X $ | 1
B-Type Natriuretic Peptide						| $< X$   | 0
B-Type Natriuretic Peptide						| $>= X $ | 1
