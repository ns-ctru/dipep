...
```{r results_existing_roc, echo = FALSE, cache = FALSE, results = 'rmarkdown', eval = TRUE}
...
to.plot
existing.auc %>%
    mutate(Score = case_when(.$group == 1 ~ 'PERC',
                                .$group == 2 ~ 'Simplified Revised Geneva',
                                .$group == 3 ~ 'Wells (Permissive)',
                                .$group == 3 ~ 'Wells (Strict)')) %>%
...
```{r results_existing_wells_permissive, echo = FALSE, cache = FALSE, results = 'markdown', eval = TRUE}
## Summarise
...
```{r results_existing_wells_strict, echo = FALSE, cache = FALSE, results = 'markdown', eval = TRUE}
## Summarise
