...
```{r results_biomarker_excl_anti_coag_gestation_ddimer_elisa, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
...
```{r results_biomarker_excl_anti_coag_gestation_ddimer_innovan, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_aptt, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_prothombin, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_clauss_fibrinogen, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_thrombin_generation_lag_time, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_thrombin_generation_endogenous_potential, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_thrombin_generation_peak, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_thrombin_generation_time_to_peak, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_plasmin_antiplasmin, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_nppb, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_mrproanp, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
...
```{r results_biomarker_excl_anti_coag_gestation_tissue_factor, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
ggplot(aes(x = gestation, y = mrproanp, colour = first.st)) +
    geom_point() +
    geom_smooth(method = 'loess') +
...
```{r results_biomarker_excl_anti_coag_gestation_prothrombin_fragments, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 10, results = 'markup', , eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE') & exclude.anti.coag == 'No') %>%
