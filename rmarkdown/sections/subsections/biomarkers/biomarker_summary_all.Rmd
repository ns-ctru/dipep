...
```{r  demographics_biomarker_all_ddimer_innovan_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
```{r  demographics_biomarker_all_ddimer_elisa_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
