...
```{r  demographics_biomarker_all_nppb_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = TRUE,
...
```{r  demographics_biomarker_all_tissue_factor_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = TRUE,
...
```{r  demographics_biomarker_all_pf12_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = TRUE,
