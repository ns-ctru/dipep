...
```{r  demographics_biomarker_all_summary, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
...
```{r  demographics_biomarker_all_aptt_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'APTT') %>%
...
```{r  demographics_biomarker_all_prothombin_time_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Prothombin (Time)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_clauss_fibrinogen_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Clauss Fibrinogen') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_ddimer_innovan_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'D-Dimer (Innovance)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_ddimer_innovan_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = FALSE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
```{r  demographics_biomarker_all_ddimer_innovan_pooled_primary_class_corr, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, !is.na(d.dimer) & !is.na(ddimer.innovance)) %>%
...
```{r  demographics_biomarker_all_ddimer_elisa_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'D-Dimer (ELISA)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_ddimer_elisa_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = FALSE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
ggplot(aes(x = gestation, y = ddimer.elisa.pooled, colour = first.st)) +
    geom_point() +
    ## geom_smooth(method = 'loess') +
...
```{r  demographics_biomarker_all_ddimer_elisa_pooled_primary_class_corr, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
...
```{r  demographics_biomarker_all_thrombin_generation_lag_time_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Thrombin Generation (Lag Time)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_thrombin_generation_endogenous_potential_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Thrombin Generation (Endogenous Potential)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_thrombin_generation_time_to_peak_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Thrombin Generation (Time to Peak)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_thrombin_generation_peak_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Thrombin Generation (Peak)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_plasmin_antiplasmin_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Plasmin (Antiplasmin)') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_nppb_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
```{r  demographics_biomarker_all_mrproanp_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'MRproANP') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_tissue_factor_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = TRUE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'Tissue Factor') %>%
    dplyr::select(-Measurement) %>%
...
```{r  demographics_biomarker_all_pf12_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = TRUE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
to.plot$histogram
to.plot$scatter
dplyr::filter(summary.biomarkers.all$first.st, Measurement == 'PF 1 + 2') %>%
    dplyr::select(-Measurement) %>%
