...
```{r results_biomarker_logistic_excl_anti_coag_performance_continuous, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, results = 'markup', eval = TRUE}
## Combine the predicted probabilities based on laboratory reference range classification and
## generate ROC curves/summary Statistics
...
```{r results_biomarker_logistic_excl_anti_coag_summary, echo = FALSE, cache = FALSE, warning = FALSE, message = FALSE, results = 'markup', eval = TRUE}
