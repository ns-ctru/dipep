...
biomarker.all$ddimer.elisa.pooled <- dipep_glm(df = dipep,
                                               exclude.dvt           = TRUE,
                                               exclude.non.recruited = TRUE,
                                               exclude.anti.coag     = FALSE,
                                               exclude.missing       = FALSE,
                                               classification = 'first.st',
                                               predictor      = 'ddimer.elisa.pooled',
                                               model          = 'D-Dimer (ELISA) - Pooled')
## D-Dimer (Innovance) Pooled
biomarker.all$ddimer.innovance.pooled <- dipep_glm(df = dipep,
                                               exclude.dvt           = TRUE,
                                               exclude.non.recruited = TRUE,
                                               exclude.anti.coag     = FALSE,
                                               exclude.missing       = FALSE,
                                               classification = 'first.st',
                                               predictor      = 'ddimer.innovance.pooled',
                                               model          = 'D-Dimer (Innovance) - Pooled')
...
biomarker.all$glance <- rbind(biomarker.all$prothombin.time$glance,
                          ...
                          biomarker.all$ddimer.innovance.pooled$glance,
                          biomarker.all$ddimer.elisa$glance,
                          biomarker.all$ddimer.elisa.pooled$glance,
...
biomarker.all$predicted <- rbind(biomarker.all$prothombin.time$predicted,
                             ...
                             biomarker.all$ddimer.innovance.pooled$predicted,
                             biomarker.all$ddimer.elisa$predicted,
                             biomarker.all$ddimer.elisa.pooled$predicted,
