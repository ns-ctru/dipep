```{r biomarkers_logistic_all, echo = FALSE, cache = FALSE, message = FALSE, results = 'hide', eval = TRUE}
...
```{r results_biomarker_logistic_all_summary, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
```{r results_biomarker_logistic_all_roc, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
...
rbind(biomarker.all$roc.other$plot.auc,
      biomarker.all$roc.thrombin$plot.auc) %>%
    ## dplyr::select(-c(x, y)) %>%
...
```{r results_biomarker_logistic_all_performance, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
