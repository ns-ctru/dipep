...
biomarker.excl.anti.coag$ddimer.elisa.pooled <- dipep_glm(df = dipep,
                                               exclude.dvt           = TRUE,
                                               exclude.non.recruited = TRUE,
                                               exclude.anti.coag     = TRUE,
                                               exclude.missing       = FALSE,
...
biomarker.excl.anti.coag$ddimer.innovance.pooled <- dipep_glm(df = dipep,
                                               exclude.dvt           = TRUE,
                                               exclude.non.recruited = TRUE,
                                               exclude.anti.coag     = TRUE,
                                               exclude.missing       = FALSE,
...
biomarker.excl.anti.coag$glance <- rbind(biomarker.excl.anti.coag$prothombin.time$glance,
                          ...
                          biomarker.excl.anti.coag$ddimer.innovance.pooled$glance,
                          biomarker.excl.anti.coag$ddimer.elisa$glance,
                          biomarker.excl.anti.coag$ddimer.elisa.pooled$glance,
...
biomarker.excl.anti.coag$predicted <- rbind(biomarker.excl.anti.coag$prothombin.time$predicted,
                             ...
                             biomarker.excl.anti.coag$ddimer.innovance.pooled$predicted,
                             biomarker.excl.anti.coag$ddimer.elisa$predicted,
                             biomarker.excl.anti.coag$ddimer.elisa.pooled$predicted,
