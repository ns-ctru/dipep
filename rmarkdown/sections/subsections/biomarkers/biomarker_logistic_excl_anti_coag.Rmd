...
```{r results_biomarker_logistic_excl_anti_coag_summary, echo = FALSE, cache = FALSE, warning = FALSE, results = 'markup', eval = TRUE}
...
```{r results_biomarker_logistic_excl_anti_coag_roc, echo = FALSE, cache = FALSE, warning = FALSE, results = 'markup', eval = TRUE}
...
```{r results_biomarker_logistic_excl_anti_coag_performance, echo = FALSE, cache = FALSE, warning = FALSE, results = 'markup', eval = TRUE}
