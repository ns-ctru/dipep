...
```{r  demographics_biomarker_excl_anti_coag_ddimer_innovan_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = FALSE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
...
```{r  demographics_biomarker_excl_anti_coag_ddimer_elisa_pooled_primary_class, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, message = FALSE, fig.width = 10, eval = FALSE}
to.plot <- dipep_plot(df      = dipep,
                      exclude = NULL,
                      exclude.non.recruited = TRUE,
                      exclude.dvt           = FALSE,
