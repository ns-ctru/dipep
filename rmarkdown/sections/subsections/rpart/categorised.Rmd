...
The full summary of the pruned tree is provided.  The `r categorical.n.missing` `observations deleted due to missingness` are those classified as `exclude` rather than to a disease status.
