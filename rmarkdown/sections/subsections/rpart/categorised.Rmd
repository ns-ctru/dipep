...
## Test model
categorical <- filter(dipep, group %in% c('Diagnosed PE', 'Suspected PE'))
...
The full summary of the pruned tree is provided.

```{r results_rpart_categorical_summary, echo = FALSE, cache = FALSE, results = 'asis', eval = TRUE}
