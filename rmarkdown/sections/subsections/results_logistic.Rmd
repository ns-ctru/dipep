...
```{r results_logistic_regression, echo = FALSE, cache = FALSE, message = FALSE, results = 'hide', eval = TRUE}
...
```{r results_logistic_regression_cross_tab, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
