...
```{r results_biomarker_regression_performance, echo = FALSE, cache = FALSE, results = 'markup', eval = TRUE}
rbind(biomarker$roc.other$summary.stats,
      biomarker$roc.thrombin$summary.stats) %>%
...
```{r child = 'biomarkers/gestation.Rmd', eval = TRUE}
```
