...
```{r results_biomarker_regression_roc, echo = FALSE, cache = FALSE, results = 'markup', eval = FALSE}
...
biomarker$roc.thrombin <- dipep_roc(df      = biomarker$predicted,
                                    ...
                                    title    = 'Thrombin/Prothombin Biomarkers')$plot
biomarker$roc.thrombing$plot
