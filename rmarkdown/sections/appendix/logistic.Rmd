...
#### Problems with Current Pregnancy Including Other
```{r child = 'logistic/this.pregnancy.problems.incl.other.Rmd', eval = TRUE}
```
...
```{r child = 'logistic/simplified.pain.palpitations.Rmd', eval = TRUE}
```
