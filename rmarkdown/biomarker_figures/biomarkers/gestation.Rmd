#### Gestation v Biomarker  {.tabset .tabset-fade .tabset-pills}
...
```{r results_biomarker_all_gestation_ddimer_elisa, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
...
```{r results_biomarker_all_gestation_ddimer_innovan, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_aptt, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_prothombin, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_clauss_fibrinogen, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_thrombin_generation_lag_time, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_thrombin_generation_endogenous_potential, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_thrombin_generation_peak, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_thrombin_generation_time_to_peak, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_plasmin_antiplasmin, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_nppb, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_mrproanp, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
...
```{r results_biomarker_all_gestation_tissue_factor, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
ggplot(aes(x = gestation, y = mrproanp, colour = first.st)) +
    geom_point() +
...
```{r results_biomarker_all_gestation_prothrombin_fragments, echo = FALSE, cache = FALSE, results = 'markup', warning = FALSE, fig.width = 10, eval = TRUE}
dplyr::filter(dipep, group %in% c('Suspected PE', 'Diagnosed PE')) %>%
