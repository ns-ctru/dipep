...
```{r child = 'excl_anti_coag_aptt.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_clauss_fibrinogen.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_prothombin_time.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_ddimer_innovance.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_ddimer_elisa.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_thrombin_generation_lag_time.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_thrombin_generation_endogenous_potential.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_thrombin_generation_peak.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_thrombin_generation_time_to_peak.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_plasmin_antiplasmin.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_mrproanp.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_bnp.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_tissue_factor.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_prothrombin_fragments.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_troponin.Rmd', eval = FALSE}
```

```{r child = 'excl_anti_coag_crp.Rmd', eval = FALSE}
```
